package net.ghoul.practice.match.team;
...
public class TeamPlayer {
    ...
    public void handleHit() {
        ...
        if (match.getKit().getName().toLowerCase().contains("boxing") && hits >= 100) {
            match.handleDeath(match.getOpponentPlayer(getPlayer()), getPlayer(), false);
        }
    }
