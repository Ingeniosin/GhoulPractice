package net.ghoul.practice.util.external.menu.menus;

import net.ghoul.practice.util.external.callback.TypeCallback;
import net.ghoul.practice.util.external.menu.Button;
import net.ghoul.practice.util.external.menu.Menu;
import net.ghoul.practice.util.external.menu.button.ConfirmationButton;
